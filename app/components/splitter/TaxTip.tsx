...
export function TaxTip({
  ...
  const inputClass =
    "w-full rounded-lg border border-ctp-surface1/50 bg-ctp-surface0 px-3 py-2 text-sm text-ctp-text placeholder-ctp-overlay0 focus:border-ctp-teal focus:outline-none focus:ring-1 focus:ring-ctp-teal/30";
