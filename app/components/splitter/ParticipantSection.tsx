  ...
  return (
    <section className="flex flex-col gap-4">
      <div className="flex items-center gap-2">
        ...
        <h2 className={["text-lg font-bold", hasError ? "text-ctp-red" : "text-ctp-text"].join(" ")}>
          People
        </h2>
        ...
        <div className="flex flex-wrap gap-2">
          {participants.map((p) => (
            <div
              ...
              style={{ borderColor: p.color?.bg ?? "#888", background: (p.color?.bg ?? "#888") + "26" }}
            >
              ...
              {!readOnly && (
                <button
                  ...
                  style={{ background: (p.color?.fg ?? "#aaa") + "33", color: p.color?.fg ?? "#aaa" }}
